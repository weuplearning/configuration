...
# bash <(curl -s https://raw.githubusercontent.com/weuplearning/configuration/master/util/install/ansible-bootstrap.sh)
...
if [[ -z "${CONFIGURATION_REPO}" ]]; then
  CONFIGURATION_REPO="https://github.com/weuplearning/configuration.git"
fi
